...
!function (e, n, t) {
  function r(e, n) {
    ...
    function i() {
      ...
      var a = m(e, s);if (!r(a, "undefined")) return a;
      ...
      if (h = e[p], v = z.style[h], f(h, "-") && (h = u(h)), z.style[h] !== t) {
        if (o || r(s, "undefined")) return i(), "pfx" == n ? h : !0;try {
          z.style[h] = s;
        } catch (g) {}if (z.style[h] != v) return i(), "pfx" == n ? h : !0;
      }
    }return i(), !1;
  }function v(e, n, t, s, o) {
    var i = e.charAt(0).toUpperCase() + e.slice(1),
        l = (e + " " + b.join(i + " ") + i).split(" ");return r(n, "string") || r(n, "undefined") ? h(l, n, s, o) : (l = (e + " " + E.join(i + " ") + i).split(" "), a(l, n, t));
  }function y(e, n, r) {
    return v(e, t, t, n, r);
  }var g = [],
      C = [],
    ...
    delete z.style;
  }), w.testAllProps = v, w.testAllProps = y, Modernizr.addTest("csstransitions", y("transition", "all", !0)), s(), o(g), delete w.addTest, delete w.addAsyncTest;for (var N = 0; N < Modernizr._q.length; N++) {
    Modernizr._q[N]();
